...
- 8a3203e: Sync generated skills with latest Google Discovery API specs

## 0.24.2

### Patch Changes

- 7ef1aac: Sync generated skills with latest Google Discovery API specs

## 0.24.1

### Patch Changes

- 117a53b: Fix no-auth mode (`GOOGLE_WORKSPACE_CLI_AUTH=none`) masking proxy 401/403 denials as "No credentials provided". The proxy's real error message is now surfaced verbatim; the "run `gws auth login`" hint still fires for the genuine forgot-to-log-in case.
...
- 42b17cb: Sync generated skills with latest Google Discovery API specs
